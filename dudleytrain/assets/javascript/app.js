...
// 1. Link to Firebase
var trainData = new Firebase("https://dudley-project.firebaseio.com/");
...
$("#addTrainBtn").on("click", function(){
	...
	// Creates local "temporary" object for holding train data using a new variable named "newTrain"
	var newTrain = {
		name:  trainName,
	...
	// Uploads train data to the database which will increase user awareness for newTrain content
	trainData.push(newTrain);

	// Logs everything to console to check output 
	console.log(newTrain.name);
	console.log(newTrain.destination);
	console.log(firstTrainUnix);
	console.log(newTrain.frequency)

	// Alert on screen to let the user know that the user content has been added sucecessfullys. 
